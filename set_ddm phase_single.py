import header as hd
# 配置基础DDM波形，使用一次循环配置移相码，使用16个子带和8组相位码，测试空子带能量

# 设置参数，t0~t6,slope1,slope2,NSTART
# 这一组对应0.2m分辨率,512个采样点，256个chirp，注意修改采样数和chirp数
t_config = [20, 2, 20.48, 2, 6.12, 3.2, 1]            # 0.2m
slope1 = 36.5
primary_file_name = "ddm_0.2m_512_256_phase_16_test_primary.dat"
secondary_file_name = "ddm_0.2m_512_256_phase_16_test_secondary.dat"
...
# 循环操作码，设置循环次数，0x0100->256
loop_code_words1 = ['E0','01','01','00']                    # 循环操作码，开始循环，内部循环
...
modify_phase_code_words2 = ['B3','04','04','00',            # 修改相位操作码，设置循环相位，24~25
                            '03','0C','0C','20']
...
for i in range(0,len(secondary_list)):
    ...
    if secondary_list[i] == 'B3':
        secondary_list[i+1] = '14'                          # 从芯片相位设置
        secondary_list[i+2] = '0C'
        secondary_list[i+3] = '40'
        secondary_list[i+4] = '03'
        secondary_list[i+5] = '1C'
        secondary_list[i+6] = '0C'
        secondary_list[i+7] = '60'
