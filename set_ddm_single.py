import header as hd
# 配置基础DDM波形，使用一次循环配置移相码，移相码添加到有效负载段ADC数据正常
...
# 循环操作码，设置循环次数，0x0180->384,0x018C->396
loop_code_words1 = ['E0','01','01','8C']                    # 循环操作码，开始循环
...
modify_phase_code_words2 = ['B3','05','84','00',            # 修改相位操作码，设置循环相位，24~25
                            '03','10','8C','2C']
...
for i in range(0,len(secondary_list)):
    ...
    if secondary_list[i] == 'B3':
        secondary_list[i+1] = '1B'                          # 从芯片相位设置
        secondary_list[i+2] = '8C'
        secondary_list[i+3] = '58'
        secondary_list[i+4] = '03'
        secondary_list[i+5] = '26'
        secondary_list[i+6] = '8C'
        secondary_list[i+7] = '84'
